...
def F(c1,c2,c3,R_target):#目标函数
    return calcu_delta_E(calcuLab(calcuXYZ(calcuR(c1,c2,c3))),calcuLab(calcuXYZ(R_target)))

#以下为模拟退火算法求解函数优化问题
import random
import math
R_target = [0.681044,0.724153,0.749374,0.752377,0.733554,0.699726,0.663874,0.652066,\
            0.642280,0.689994,0.720488,0.725711,0.732905,0.771153,0.838096,0.859082] 
sol_new1 = 2.5#初始值
sol_new2 = 2.5
sol_new3 = 2.5
...
while T >= T1:
    ...
    while times < 1000:
        ...
        sol_new01*sol_new02 + sol_new01*sol_new03 + sol_new02*sol_new03 > 1e-7:
            ...
            times -= 1
            continue
        E_new = F(sol_new1,sol_new2,sol_new3,R_target)
        if E_new < E_current:
            E_current = E_new
